...
camera.position.setZ(-100); // Reverse the camera position along the Z-axis
...
const positions = [
  ...
  [1200, 600, 0], [1200, 600, 600], [1200, 600, -600],
  [1200, 0, -600], [1200, 0, 600], [1200, 0, 0],
...
loader.load('models/scene.gltf', function (gltf) {
  ...
  flashlight.position.z = -90; // Reverse the flashlight position along the Z-axis
  flashlight.position.x = -25; // Reverse the flashlight position along the X-axis
...
/* const amb = new THREE.AmbientLight(0xfffffff)
scene.add(amb); */